...
function blogColumnTwo() {
  return (
    <>
      <MainLayout>
        <Breadcrumb pageName="2 Column Blog" pageTitle="2 Column Blog" />
        <div className="blog-section pt-120 pl-180 pr-180">
          <div className="container-fluid">
            <div className="row justify-content-center mb-30">
              {blogData.map((item) => {
                ...
                return (
                  <div key={id} className="col-lg-6 col-md-6 col-sm-9">
                    <div className="blog-two-single">
                      <div className="blog-image">
                        <img src={col_three_img} alt="image" />
