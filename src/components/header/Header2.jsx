...
function Header2() {
  ...
  return (
    <>
      <div className="topbar d-md-flex d-none topbar-bg">
        <div className="container">
          <div className="topbar-area bg-transparent d-flex justify-content-between">
        ...
        <div className="container-fluid d-flex justify-content-between align-items-center px-0">
            ...
            <Link legacyBehavior href="/">
              <a>
                <img
                  alt="image"
                  className="img-fluid"
                  src="assets/images/bg/header-logo2.svg"
                />
              </a>
            </Link>
          </div>
          <div className="main-nav">
                ...
                >
                  ...
                  <li>
                    <Link legacyBehavior href="/index-digital-marketing">
                      <a className="active">Home Digital Marketing</a>
                    </Link>
                  </li>
                  <li>
            ...
            <div className="d-flex justify-content-start align-items-center flex-row d-lg-none d-block mt-5">
              <Link legacyBehavior href="/service-details">
                <a className="eg-btn btn--primary btn--lg w-100 d-flex d-lg-none">
                  Request a Quote
                </a>
              </Link>
            </div>
          ...
          <div className="nav-right header-five-right d-flex jsutify-content-end align-items-center gap-sm-5 gap-4">
            <div className="header-icons style-two">
              <a href="#" className="search-btn">
                <i className="bi bi-search" onClick={toggleModal} />
              </a>
              <a href="#" className="cart-icon">
                <i className="bi bi-bag-check" />
              </a>
            </div>
            <div className="header-phone-five">
              <div className="icon">
            ...
            <Link legacyBehavior href="/service-details">
              <a className="eg-btn btn--md btn--primary btn--capsule d-xl-flex d-none">
                Get Started
              </a>
            </Link>
