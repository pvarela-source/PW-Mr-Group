              ...
              <div className="footer-info">
                <Link legacyBehavior href="/">
                  <a className="footer-logo">
                    <img src="assets/images/bg/footer6-logo.svg" alt="image" />
                  </a>
                </Link>
                <span>
                ...
                <ul className="footer-social sibling-four">
                  <li>
              ...
              <div className="row mb-70 gy-5">
                <div className="col-lg-4 col-md-4 col-sm-6">
                  <div className="footer-list-area">
                    ...
                    <ul className="footer-list sibling-four">
                      <li>
                ...
                <div className="col-lg-5 col-md-5 col-sm-6">
                  <div className="footer-list-area">
                    ...
                    <ul className="footer-address-list sibling-four">
                      <li>
                        <div className="icon">
