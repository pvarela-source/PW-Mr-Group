    ...
    <>
      <div className="choose-us-section pt-120 pb-120">
        <div className="container">
            ...
            <div className="col-lg-10">
              <div className="section-title-one">
                <div className="section-subtitle d-flex justify-content-center">
                  <img
                    src="assets/images/icons/title-shape-before.svg"
                    alt=""
                  />
                  Why Choose
          ...
          <div className="row align-items-center pb-90 gy-4">
            ...
            <div className="col-lg-4 order-lg-2 order-3 text-center">
              <PieChart
                data={[
                  { title: "Falle", value: 10, color: "#E38627" },
                  { title: "Spring", value: 15, color: "#C13C37" },
                  { title: "Summer", value: 20, color: "#6A2135" },
                  { title: "Winter", value: 20, color: "red" },
                ]}
              />
            </div>
          ...
          <div className="row">
            <div className="company-vdo mb-0 position-relative">
